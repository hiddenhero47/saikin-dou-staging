...
class BroadcastTemplateUpdateRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        if ($this->broadcast_template) {
             ...
             * Check if the user is an administrator with permission of update_broadcast_template
             */
            if (auth()->user()->isAbleTo('update_broadcast_template', 'administrator')) {
                return true;
            }
    ...
    public function rules()
    {
        return [
            ...
            'contact_group_id' => 'sometimes|required_without:whatsapp_group_names|integer|min:1|exists:groups,id,user_id,'.auth()->user()->id,
            'whatsapp_group_names' => 'sometimes|required_without:contact_group_id|array|min:1|filled',
    ...
    public function messages()
    {
        return [
            ...
            'message.sometimes' => 'A message should be present, else entirely exclude the field',
            'message.required' => 'A message field maybe required',
            ...
            'whatsapp_group_names.sometimes' => 'A whats app group names field should be present, else entirely exclude the field',
            'whatsapp_group_names.required_without' => 'A whats app group names field maybe required if there is no contact group id',
