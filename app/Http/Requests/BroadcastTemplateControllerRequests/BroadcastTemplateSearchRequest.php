...
class BroadcastTemplateSearchRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is a manager with permission of search_index_broadcast_template
         */
        if (auth()->user()->isAbleTo('search_index_broadcast_template', 'administrator')){
            return true;
        }
