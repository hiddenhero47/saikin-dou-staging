...
class EmbeddedFormDestroyRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        if ($this->embedded_form) {
             ...
             * Check if the user is an administrator with permission of delete_embedded_form
             */
            if (auth()->user()->isAbleTo('delete_embedded_form', 'administrator')){
                return true;
            }
