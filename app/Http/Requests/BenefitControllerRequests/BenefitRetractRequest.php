...
class BenefitRetractRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is an administrator with benefit of retract_benefit
         */
        if (auth()->user()->isAbleTo('retract_benefit', 'administrator')) {
            return true;
        }
