...
class EmbeddedFormSearchRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is an administrator with permission of search_index_embedded_form
         */
        if (auth()->user()->isAbleTo('search_index_embedded_form', 'administrator')){
            return true;
        }
