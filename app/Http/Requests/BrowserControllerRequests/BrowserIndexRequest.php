...
class BrowserIndexRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is an administrator with permission of index_browser
         */
        if (auth()->user()->isAbleTo('index_browser', 'administrator')){
            return true;
        }
