...
class BrowserSearchRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is an administrator with permission of search_index_browser
         */
        if (auth()->user()->isAbleTo('search_index_browser', 'administrator')){
            return true;
        }
