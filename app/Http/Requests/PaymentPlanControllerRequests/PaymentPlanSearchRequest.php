...
class PaymentPlanSearchRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is an administrator with permission of search_index_payment_plan
         */
        if (auth()->user()->isAbleTo('search_index_payment_plan', 'administrator')){
            return true;
        }
