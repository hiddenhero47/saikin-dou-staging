...
class BroadcastFilterRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
         ...
         * Check if the user is a manager with permission of filter_index_broadcast
         */
        if (auth()->user()->isAbleTo('filter_index_broadcast', 'administrator')){
            return true;
        }
